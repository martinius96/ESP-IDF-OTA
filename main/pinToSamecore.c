...
//NORMAL MODE
  ...
  xTaskCreatePinnedToCore(
                    &task_bme280_normal_mode,   /* Function to implement the task */
                    "bme280_normal_mode", /* Name of the task */
...
//FORCED MODE
 ...
 // xTaskCreate(&task_bme280_forced_mode, "bme280_forced_mode",  2048, NULL, 6, NULL);	
   xTaskCreatePinnedToCore(
                    &task_bme280_forced_mode,   /* Function to implement the task */
                    "bme280_forced_mode", /* Name of the task */
                    2048,      /* Stack size in words */
                    NULL,       /* Task input parameter */
                    6,          /* Priority of the task */
                    NULL,       /* Task handle. */
    ...
    xTaskCreate(&ota_example_task, "ota_example_task", 8192, NULL, 5, NULL);
      xTaskCreatePinnedToCore(
                    &https_get_task,   /* Function to implement the task */
                    "https_get_task", /* Name of the task */
